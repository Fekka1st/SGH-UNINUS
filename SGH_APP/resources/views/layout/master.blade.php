...
<html lang="en">
  <head>
    ...
    <link href="{{asset('utama/asset/css/sb-admin-2.min.css')}}" rel="stylesheet"> @yield('css') <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
  </head>
  <body id="page-top"> @include('sweetalert::alert')
    <div id="wrapper">
