      ...
      <div class="row align-items-center">
          ...
          <div id="carouselExample" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2000">
            <div class="carousel-inner" style="border-radius: 15px;">
              <div class="carousel-item">
                <img src="{{asset('asset/img/rapat/r1.jpeg')}}" class="d-block w-100" alt="Gambar 1">
              </div>
              <div class="carousel-item active">
                <img src="{{asset('asset/img/rapat/rapat1.jpg')}}" class="d-block w-100" alt="Gambar 2">
              </div>
              <!-- <div class="carousel-item"><img src="{{asset('asset/img/rapat/rapat2.jpg')}}"
                              class="d-block w-100" alt="Gambar 3"></div> -->
              <div class="carousel-item">
                <img src="{{asset('asset/img/rapat/kerja.jpg')}}" class="d-block w-100" alt="Gambar 4">
              </div>
              <div class="carousel-item">
                <img src="{{asset('asset/img/rapat/rapat7.jpg')}}" class="d-block w-100" alt="Gambar 5">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6 col-md-12 d-flex" data-aos="fade-left">
          <div class="card-body d-flex flex-column justify-content-between" style="background: linear-gradient(to bottom right, #46AA46, #3FA34D, #006400, #003200, #001E00,#001400); border-radius: 15px;">
            <div>
              <h5 class="card-title mb-4" style="color:aliceblue;  font-family: 'Poppins', sans-serif;">
              ...
              <div class="mt-2">
                <span class="ml-2" style="text-align: justify; color:aliceblue;  font-family: 'Poppins', sans-serif;">
                  <b>
                    <i>Smart Green House</i>
                  </b> dalah proyek kolaboratif lintas disiplin di Universitas Islam Nusantara (Uninus) yang menggabungkan teknologi modern dengan praktik pertanian berkelanjutan. Proyek ini melibatkan keahlian dari berbagai disiplin untuk menciptakan sistem pertanian yang efisien melalui teknologi canggih, seperti sensor dan irigasi pintar, guna meningkatkan produktivitas tanaman serta penghematan sumber daya. <a href="#." id="toggleText" style="color: yellow;font-family:'Poppins', sans-serif;" onclick="toggleParagraph()">
                    <b>selengkapnya....</b>
                  </a>
                </span>
              </div>
              <div id="extraParagraph" class="mt-2" style="display: none;">
                <p class="card-text mb-3" style="text-align: justify; color:aliceblue;  font-family: 'Poppins', sans-serif;">
                  <b>Dukungan Yayasan dan Rektor Uninus</b>
                  <br> Proyek ini juga didukung oleh Yayasan Uninus dan Rektor Uninus sebagai bagian dari komitmen universitas untuk mendorong inovasi dan keberlanjutan. Rektor dan Yayasan memberikan dukungan penuh dalam penyediaan sumber daya dan fasilitasi kegiatan lintas fakultas ini. <br>
                  <b>Tim Pelaksana Proyek</b>
                  <br> Proyek Smart Greenhouse ini merupakan hasil kerja keras tim lintas disiplin dari Fakultas Pertanian dan Fakultas Teknik Uninus. Para dosen yang berperan penting dalam pengembangan proyek ini, antara lain: <br> • <b>Ir. Lilis Irmawatie, M.M.Pd</b> (Dekan Fakultas Pertanian) Sebagai penanggung jawab utama dari proyek smart greenhouse berbasis dan mengawasi keseluruhan perencanaan dan pembuatan <i>smart greenhouse</i>. <br> • <b>Dr. Debby Ustari, S.P., M.P dan Dr. Syayidah Nuriyah, S.Pd., M.Si</b> (Dosen dan Peneliti) Mengawasi keseluruhan perencanaan agronomis dan teknis di dalam <i>smart greenhouse</i>, serta bertanggung jawab dalam pengembangan penelitian yang diterapkan. <br> • <b>GALIH, S.T., M.KOM. dan Ganis Sanhaji, S.Si., M.Sc.</b> berperan dalam penerapan sistem <i>IoT</i>, khususnya dalam desain arsitektur sistem pemantauan otomatis. <br> • <b>Tim Mahasiswa</b> Mahasiswa dari Fakultas Pertanian dan Fakultas Teknik turut ambil bagian dalam proyek, baik sebagai perancang sistem maupun tenaga operasional. Mahasiwa tidak hanya mempelajari konsep teoritis tentang pertanian dan teknologi, tetapi juga mendapatkan pengalaman langsung dalam mengelola dan memantau sistem berbasis <i>IoT</i>
                </p>
                <a href="#." id="closeText" class="cursor-pointer text-blue-500" style="display: none; color:yellow;  font-family: 'Poppins', sans-serif;" onclick="toggleParagraph()">
                  <b>tutup..</b>
                </a>
              </div>
            </div>
            <p class="mt-4 mb-0 text-end" style="font-size: 17px; color:aliceblue;  font-family: 'Poppins', sans-serif;">
  ...
  <div class="card__container swiper">
    <div class="card__content">
      <div class="judul" style="display: flex; justify-content: center; align-items: center; height: 105px; margin-top: 0; margin-bottom: 50px;">
        <h5 class="card-title" style="color: aliceblue; font-size: 1.8em; font-weight: bold; text-transform: uppercase; letter-spacing: 1px; border-bottom: 2px solid #fff; padding-bottom: 10px; font-family: 'Poppins', sans-serif;text-align: center;"> DOSEN YANG TERLIBAT DALAM RISET </h5>
      </div>
      <div class="swiper-wrapper">
        ...
        <article class="card__article swiper-slide">
          ...
          <div class="card__data" style="background: linear-gradient(to left, #fff, #A8D5E3);  font-family: 'Poppins', sans-serif;">
            <h3 class="card__name">Dr.Debby Ustari,S.P.,M.P.</h3>
            <p class="card__description" style="margin-bottom:25px;"> Perakitan varietas baru ubi </p>
            <div class="card__box">
              <a href="https://sinta.kemdikbud.go.id/authors/profile/6798976" target="_blank">
        ...
        <article class="card__article swiper-slide">
          ...
          <div class="card__data" style="background: linear-gradient(to left, #fff, #A8D5E3);  font-family: 'Poppins', sans-serif;">
            <h3 class="card__name">Ir.Lilis Irmawate,M.MPd</h3>
            <p class="card__description" style="margin-bottom:25px;"> penyakit tanaman </p>
            <div class="card__box">
              <a href="https://sinta.kemdikbud.go.id/authors/profile/6100570" target="_blank">
                <img src="{{asset('asset/img/logo/logo_scopus-removebg-preview.png')}}" alt="LinkedIn" class="social-ico">
              </a>
              <a href="https://scholar.google.co.id/citations?user=3XjgmvsAAAAJ&hl=id" target="_blank">
                <img src="{{asset('asset/img/logo/logo.scholar-removebg-preview.png')}}" alt="GitHub" class="social-ico">
              </a>
            </div>
          </div>
        ...
        <article class="card__article swiper-slide">
          ...
          <div class="card__data" style="background: linear-gradient(to left, #fff, #A8D5E3);  font-family: 'Poppins', sans-serif;">
            <h3 class="card__name">Dr.Syayidah Nuriyah,S.Pd.,M.Pd</h3>
            <p class="card__description" style="margin-bottom:25px;"> lingkungan spesialis lebah <br> Trigona </p>
            <div class="card__box">
              <a href="https://sinta.kemdikbud.go.id/authors/profile/6885082" target="_blank">
                <img src="{{asset('asset/img/logo/logo_scopus-removebg-preview.png')}}" alt="LinkedIn" class="social-ico">
              </a>
              <a href="https://scholar.google.com/citations?user=hfZaRgMAAAAJ&hl=id" target="_blank">
                <img src="{{asset('asset/img/logo/logo.scholar-removebg-preview.png')}}" alt="GitHub" class="social-ico">
              </a>
            </div>
          </div>
        ...
        <article class="card__article swiper-slide">
          ...
          <div class="card__data" style="background: linear-gradient(to left, #fff, #A8D5E3);  font-family: 'Poppins', sans-serif;">
            <h3 class="card__name">Dr.Ir.Yenny Muliani,M.P</h3>
            <p class="card__description" style="margin-bottom:25px;"> entomologi </p>
            <div class="card__box">
              <a href="https://sinta.kemdikbud.go.id/authors/profile/6092620" target="_blank">
                <img src="{{asset('asset/img/logo/logo_scopus-removebg-preview.png')}}" alt="LinkedIn" class="social-ico">
              </a>
              <a href="https://scholar.google.co.id/citations?user=leikpY8qEe8C&hl=en" target="_blank">
                <img src="{{asset('asset/img/logo/logo.scholar-removebg-preview.png')}}" alt="GitHub" class="social-ico">
              </a>
            </div>
          </div>
        ...
        <article class="card__article swiper-slide">
          ...
          <div class="card__data" style="background: linear-gradient(to left, #fff, #A8D5E3);  font-family: 'Poppins', sans-serif;">
            <h3 class="card__name">Dra.Ida Adviany,M.P</h3>
            <p class="card__description" style="margin-bottom:25px;"> Biologi tanaman </p>
            <div class="card__box">
              <a href="https://sinta.kemdikbud.go.id/authors/profile/6100664" target="_blank">
                <img src="{{asset('asset/img/logo/logo_scopus-removebg-preview.png')}}" alt="LinkedIn" class="social-ico">
              </a>
              <a href="https://scholar.google.co.id/citations?user=i0ZlJigAAAAJ&hl=en" target="_blank">
                <img src="{{asset('asset/img/logo/logo.scholar-removebg-preview.png')}}" alt="GitHub" class="social-ico">
              </a>
            </div>
          </div>
        ...
        <article class="card__article swiper-slide">
          ...
          <div class="card__data" style="background: linear-gradient(to left, #fff, #A8D5E3);  font-family: 'Poppins', sans-serif;">
            <h3 class="card__name">Ir.Suli Suswana,MS.I</h3>
            <p class="card__description" style="margin-bottom:25px;"> Soil Saintis </p>
            <div class="card__box">
              <a href="https://sinta.kemdikbud.go.id/authors/profile/6109046" target="_blank">
                <img src="{{asset('asset/img/logo/logo_scopus-removebg-preview.png')}}" alt="LinkedIn" class="social-ico">
              </a>
              <a href="https://scholar.google.co.id/citations?user=axsg-_QAAAAJ&hl=id" target="_blank">
                <img src="{{asset('asset/img/logo/logo.scholar-removebg-preview.png')}}" alt="GitHub" class="social-ico">
              </a>
            </div>
          </div>
  ...
  <div class="card__container swiper">
    <div class="card__content">
      <div class="judul" style="display: flex; justify-content: center; align-items: center; height: 105px; margin-top: -0px; margin-bottom: 50px;">
        <h4 class="card-title" style="color: #1C532A; font-size: 1.8em; font-weight: bold; text-transform: uppercase; letter-spacing: 1px; border-bottom: 2px solid #1C532A; padding-bottom: 10px;  font-family: 'Poppins', sans-serif;"> TIM MAHASISWA </h4>
      </div>
      <div class="swiper-wrapper">
        <!-- tim inti mahasiswa -->
        <article class="card__article swiper-slide">
          ...
          <div class="card__data" style="background: linear-gradient(to bottom right, #3FA34D, #006400, #001400);  font-family: 'Poppins', sans-serif;">
            ...
            <p class="card__description" style="color:aliceblue;"> Team Support <br> Mahasiswa FTAN
        ...
        <article class="card__article swiper-slide">
          ...
          <div class="card__data" style="background: linear-gradient(to bottom right, #3FA34D, #006400, #001400);  font-family: 'Poppins', sans-serif;">
            ...
            <p class="card__description" style="color:aliceblue; margin-top:-26px;"> Team Support : <br>Silmi Nur Azmi </p>
            <div class="card__box">
        ...
        <article class="card__article swiper-slide">
          ...
          <div class="card__data" style="background: linear-gradient(to bottom right, #3FA34D, #006400, #001400);  font-family: 'Poppins', sans-serif;">
            ...
            <p class="card__description" style="color:aliceblue;">DevOps Devision</p>
        ...
        <article class="card__article swiper-slide">
          ...
          <div class="card__data" style="background: linear-gradient(to bottom right, #3FA34D, #006400, #001400);  font-family: 'Poppins', sans-serif;">
            ...
            <p class="card__description" style="color:aliceblue; margin-top:-26px;"> Team Support: Anisa Febrianti dan Anita Ayudya Riski </p>
            <div class="card__box">
        ...
        <article class="card__article swiper-slide">
          ...
          <div class="card__data" style="background: linear-gradient(to bottom right, #3FA34D, #006400, #001400);  font-family: 'Poppins', sans-serif;">
            ...
            <p class="card__description" style="color:aliceblue; margin-top:-26px;"> Team Support : Muhamad Ihsan dan Raihan Wahyu Pratama </p>
            <div class="card__box">
        ...
        <article class="card__article swiper-slide">
          ...
          <div class="card__data" style="background: linear-gradient(to bottom right, #3FA34D, #006400, #001400);  font-family: 'Poppins', sans-serif;">
            ...
            <p class="card__description" style="color:aliceblue;">Hardware Division</p>
            <p class="card__description" style="color:aliceblue; margin-top:-26px;"> Team Support : Deri Bahtiar dan <br>Kusnayadi </p>
            <div class="card__box">
        ...
        <article class="card__article swiper-slide">
          ...
          <div class="card__data" style="background: linear-gradient(to bottom right, #3FA34D, #006400, #001400);  font-family: 'Poppins', sans-serif;">
            ...
            <p class="card__description" style="color:aliceblue;">Hardware Division</p>
            <p class="card__description" style="color:aliceblue; margin-top:-26px;"> Team Support : Muhamad Gias Muharom dan Vito Dwi Nur H </p>
            <div class="card__box">
        ...
        <article class="card__article swiper-slide">
          ...
          <div class="card__data" style="background: linear-gradient(to bottom right, #3FA34D, #006400, #001400);  font-family: 'Poppins', sans-serif;">
            ...
            <p class="card__description" style="color:aliceblue; margin-top:-26px;"> Team Support : Ahmad Kurnia dan Wildan Permana </p>
            <div class="card__box">
        ...
        <article class="card__article swiper-slide">
          ...
          <div class="card__data" style="background: linear-gradient(to bottom right, #3FA34D, #006400, #001400);  font-family: 'Poppins', sans-serif;">
            ...
            <p class="card__description" style="color:aliceblue;">Electrical Division</p>
            <p class="card__description" style="color:aliceblue; margin-top:-26px;"> Team Support :Hidayat
            <p style="margin-top:-10px">
              <br>
            </p>
            </p>
        ...
        <article class="card__article swiper-slide">
          ...
          <div class="card__data" style="background: linear-gradient(to bottom right, #3FA34D, #006400, #001400);  font-family: 'Poppins', sans-serif;">
            ...
            <p class="card__description" style="color:aliceblue; margin-top:-26px;"> Team Support : Zen Ahlil B Dan <br>Adam Panji </p>
            <div class="card__box">
        ...
        <article class="card__article swiper-slide">
          ...
          <div class="card__data" style="background: linear-gradient(to bottom right, #3FA34D, #006400, #001400);  font-family: 'Poppins', sans-serif;">
            ...
            <p class="card__description" style="color:aliceblue;">Frontend</p>
            <p class="card__description" style="color:aliceblue; margin-top:-26px;"> Desain antarmuka untuk pengalaman yang optimal </p>
            <div class="card__box">
        ...
        <!-- Adam Panji -->
        <!-- <article class="card__article swiper-slide"><div class="card__image" style="display: flex; justify-content: center; align-items: center; position: relative;"><img src="{{asset('asset/img/mahasiswa/adam.png')}}" alt="image" class="card__img" style="width: 180px; height: 200px;"><div class="card__shadow"></div></div><div class="card__data" style="background-color: #1C532A;  font-family: 'Poppins', sans-serif;"><h3 class="card__name" style="color:aliceblue;">Adam Panji</h3><p class="card__description" style="color:aliceblue;">Frontend</p><p class="card__description" style="color:aliceblue; margin-top:-26px;">
                                                Desain antarmuka pengguna untuk pengalaman yang optimal
                                          </p><div class="card__box"><a href="https://www.linkedin.com" target="_blank"><i class="fa-brands fa-linkedin fa-2xl" style="color: #ffffff;"></i></a><a href="https://github.com" target="_blank" style="margin-left: 20px; margin-right:20px"><i class="fa-brands fa-square-github fa-2xl" style="color: #ffffff;"></i></a><a href="https://www.instagram.com/adampanji21/</a>" target="_blank"><i class="fa-brands fa-square-instagram fa-2xl" style="color: #ffffff;"></i></a></div></div></article> -->
        <!-- END Frontend -->
        <!-- Backend -->
        <!-- Aby Herdiansyah -->
        <article class="card__article swiper-slide">
          ...
          <div class="card__data" style="background: linear-gradient(to bottom right, #3FA34D, #006400, #001400);  font-family: 'Poppins', sans-serif;">
            ...
            <p class="card__description" style="color:aliceblue; margin-top:-26px;"> Pemrograman server untuk pengolahan data aplikasi </p>
            <div class="card__box">
...
<section id="swiper-section-5" style="background: linear-gradient(to bottom right, #46AA46, #3FA34D, #003200, #001E00, #001400);">
  <div class="card__container swiper">
    <div class="card__content">
      <div class="judul" style="display: flex; justify-content: center; align-items: center; height: 105px; margin-top: 0; margin-bottom: 50px;">
        <h5 class="card-title" style="color: aliceblue; font-size: 1.8em; font-weight: bold; text-transform: uppercase; letter-spacing: 1px; border-bottom: 2px solid #fff; padding-bottom: 10px; font-family: 'Poppins', sans-serif;"> TIM VENDOR </h5>
      </div>
      <div class="swiper-wrapper">
        <!-- 1 -->
        <article class="card__article swiper-slide">
          ...
          <div class="card__data" style="background: linear-gradient(to left, #fff, #A8D5E3);  font-family: 'Poppins', sans-serif;">
            ...
            <p class="card__description"> IoT Engineer | <br> Embedded System IoT <br>| Elektrical Engineer </p>
            <div class="card__box">
        ...
        <article class="card__article swiper-slide">
          ...
          <div class="card__data" style="background: linear-gradient(to left, #fff, #A8D5E3);  font-family: 'Poppins', sans-serif;">
            <h3 class="card__name">Ferry Aditya Herman,S.T</h3>
            <p class="card__description"> Web Developer | <br>IoT Engineer <br>| IT Support </p>
            <div class="card__box">
...
@endsection
@section('script') <script src="{{asset('asset/js/swiper-bundle.min.js')}}"></script>
