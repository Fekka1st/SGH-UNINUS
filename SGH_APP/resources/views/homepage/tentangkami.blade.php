      ...
      <div class="info-one">
        <div class="row align-items-center">
          <div class="col-lg-6 col-md-12 col-12 mb-4">
            <img src="{{asset('asset/img/batu.jpeg')}}" alt="Smart Green House" class="img-fluid h-100" style="object-fit: cover;  width: 100%; height: 100%; border-radius: 5px">
          </div>
          <div class="col-lg-6 col-md-12 d-flex" style="background: linear-gradient(to bottom right, #3FA34D, #006400, #001400); border-radius: 10px;">
            <div class="card-body d-flex flex-column justify-content-between">
              ...
              <p class="text-justify" style="color: #fff;  font-family: 'Poppins', sans-serif; text-align: justify; font-size: 20px"> Smart Greenhouse berbasis IoT Fakultas Pertanian Uninus dimulai dari visi untuk memodernisasi praktik pertanian di Indonesia melalui teknologi canggih. Proyek ini didirikan pada tahun 2024 sebagai tanggapan terhadap tantangan global di bidang pertanian, seperti perubahan iklim, ketidakstabilan cuaca, dan kebutuhan akan efisiensi sumber daya. </p>
              <p>
                <br>
              </p>
              <p class="text-justify" style="color: #fff; font-family: 'Poppins', sans-serif; text-align: justify; font-size: 20px;"> Kolaborasi antara agronomi dan teknik menghasilkan sistem yang memungkinkan pemantauan dan pengendalian lingkungan greenhouse secara otomatis dan real-time. Teknologi ini membantu memastikan pertumbuhan optimal tanaman sepanjang musim. </p>
            </div>
          </div>
        </div>
      </div>
