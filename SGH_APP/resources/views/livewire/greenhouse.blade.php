                    ...
                    <div class="col-md-6 mb-3">
                      <div class="card bg-primary">
                        <div class="card-body text-center">
                          ...
                          <h6 class="card-subtitle mb-2 text-white">{{$data->kelembaban_avg}}% </h6>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col mr-2">
                  <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Water Level
                    ...
                    <h7 style="color:rgb(126, 126, 126); margin-left: 10px;">
                      <i class="fas fa-circle" style="color: #00d604;"></i> Online
                    </h7>
                    @else
                    <h7 style="color:rgb(126, 126, 126); margin-left: 10px;">
                      <i class="fas fa-circle" style="color: #c70000;"></i> Offline
                    </h7>
                    @endif
                </div>
        ...
        <div class="col-xl-12 col-lg-12">
          <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              <h6 class="m-0 font-weight-bold text-primary" style="text-align: center; margin: 2%; width: 100%">Controlling Green House</h6>
            </div>
            <div class="container" wire:poll="fan">
              <div class="d-flex flex-wrap justify-content-center align-items-center;" style="margin: 2%">
                <div class="m-3">
                  <button class="btn btn-primary" wire:click="toggleFan('Cooling_System')" style="border: 1px solid #4e73df; padding: 17px; width: 180px;">
    ...
    <div class="row">
      <div class="col-xl-12 col-lg-12 m-2">
        <div class="card shadow mb-4">
          ...
          <br>
          <div class="row p-1">
            <div class="col-xl-6 col-lg-122">
              <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary" style="text-align: center; margin: 2%; width: 100%">Temperature and Humidity</h6>
                </div>
                <div class="card-body">
            ...
            <div class="col-xl-6 col-lg-12">
              <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary" style="text-align: center; margin: 2%; width: 100%">Light Intensity</h6>
                </div>
                <div class="card-body">
                  <div class="chart-area" wire:ignore>
            ...
            <div class="col-xl-6 col-lg-12">
              <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary" style="text-align: center; margin: 2%; width: 100%">CO₂</h6>
                </div>
                <div class="card-body">
                  <div class="chart-area" wire:ignore>
          ...
          <div class="modal-body">
            <form wire:submit.prevent="update">
              <div style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
                <div>
                  <label for="minTemp" style="width: 120px;">Cooling Active: </label>
                  <input type="number" name="Cooling_Sistem_Active" step="1" wire:model="Cooling_Sistem_Active" value="{{ $setting['Cooling_Sistem_Active'] }}" style="width: 60px; border: none; padding: 5px;" />
                  <label for="">Minute</label>
                </div>
                <div>
                  <label for="maxTemp" style="width: 121px;">Cooling Inactive: </label>
                  <input type="number" name="Cooling_Sistem_Inactive" step="1" wire:model="Cooling_Sistem_Inactive" value="{{ $setting['Cooling_Sistem_Inactive'] }}" style="width: 60px; border: none; padding: 5px;" />
                  <label for="">Minute</label>
                </div>
                <br>
              </div>
