<div>
    <div class="container-fluid" wire:poll="refreshData">
      <div class="row">
        ...
        <h2 class="h4 mt-2 ml-1" style="color:#57F000">
          <b>ONLINE</b>
        </h2>
        @else
        <h1 class="h2 mb-2 text-gray-800">
        ...
        <h2 class="h4 mt-2 ml-3">Status Device : </h2>
        <h2 class="h4 mt-2 ml-1" style="color:#FE3839">
          <b>OFFLINE - Last seen: {{ $lastSeen }}</b>
        </h2>
        @endif
      </div>
      <div class="row">
          ...
          <div class="card border-left-primary shadow h-100 py-2">
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"> Water PH </div>
                  <div>
                    {{$data->ph_air}} pH
                  </div>
                </div>
        ...
        <div class="col-xl-4 col-md-6 mb-4">
          <div class="card border-left-primary shadow h-100 py-2">
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"> Nutrition </div>
                  <div>
                    {{$data->tds}} PPM
                  </div>
                </div>
        ...
        <div class="col-xl-4 col-md-6 mb-4">
          <div class="card border-left-primary shadow h-100 py-2">
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"> Water Temperature </div>
                  <div>
                    {{$data->suhu_air}} °C
                  </div>
                </div>
        ...
        <div class="col-xl-4 col-md-6 mb-4">
          <div class="card border-left-primary shadow h-100 py-2">
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"> Panel Temp. </div>
                  <div>
                    {{$data->panel_temp}} °C
                  </div>
                </div>
            ...
            <div class="container">
              ...
              <div class="container" wire:poll="pump()">
                <div class="d-flex flex-wrap justify-content-center align-items-center;" style="margin: 2%">
                  <div class="m-3">
                    <button wire:click="togglePump('Pompa_PHUP')" class="btn btn-primary btn-sm w-100" style="border: 1px solid #4e73df; padding: 21px; width: 160px;">
                  ...
                  <div class="m-3">
                    <button wire:click="togglePump('Pompa_PHDOWN')" class="btn btn-primary btn-sm w-80" style="border: 1px solid #4e73df; padding: 9px; width: 160px;">
                  ...
                  <div class="m-3">
                    <button wire:click="togglePump('Pompa_Nutrisi')" class="btn btn-primary btn-sm w-120" style="border: 1px solid #4e73df; padding: 21px; width: 160px;">
                  ...
                  <div class="m-3">
                    <button wire:click="togglePump('Pompa_Spraying')" class="btn btn-primary btn-sm w-120" style="border: 1px solid #4e73df; padding: 21px; width: 160px;">
              ...
              <div class="container text-center mb-4">
                <div class="row justify-content-center">
                  <div class="col-6 col-md-2 mb-2">
                    @if($device->mode == 1)
                    <button class="btn btn-primary btn-sm w-100" wire:click="changemode('{{$device->id}}')" type="submit">Auto</button> @else <button class="btn btn-primary btn-sm w-100" wire:click="changemode('{{$device->id}}')" type="submit">Manual</button> @endif </div>
                  <div class="col-6 col-md-2 mb-2">
                    <button type="button" class="btn btn-primary btn-sm w-100" wire:click="openModal">Setting</button>
                  </div>
                </div>
              </div>
              <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModal" aria-hidden="true" wire:ignore.self>
                      ...
                      <form wire:submit.prevent="update">
                        <div style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
                          <div>
                            ...
                            <input type="number" name="Limit_ph_min" step="0.1" wire:model="Limit_ph_min" value="{{ $setting['Limit_ph_min'] }}" style="width: 80px; border: none; padding: 5px;" />
                            <label for="maxTemp">PH </label>
                          </div>
                          <div>
                            <label for="maxTemp" style="width: 153px;">Water PH Down:</label>
                            <input type="number" name="Limit_ph_max" step="0.1" wire:model="Limit_ph_max" value="{{ $setting['Limit_ph_max'] }}" style="width: 80px; border: none; padding: 5px;" />
                            <label for="maxTemp">PH </label>
                          </div>
                          <br>
                          <div>
                            <label for="minTemp" style="width: 150px;">Nutrition Up:</label>
                            <input type="number" name="Limit_nutrisi_min" wire:model="Limit_nutrisi_min" value="{{ $setting['Limit_nutrisi_min'] }}" style="width: 71px; border: none; padding: 5px;" />
                            <label for="maxTemp">PPM </label>
                          </div>
                          <div>
                            <label for="maxTemp" style="width: 150px;">Nutrition Down:</label>
                            <input type="number" name="Limit_nutrisi_max" wire:model="Limit_nutrisi_max" value="{{ $setting['Limit_nutrisi_max'] }}" style="width: 70px; border: none; padding: 5px;" />
                            <label for="maxTemp">PPM </label>
                          </div>
                          <br>
                          <div>
                            <label for="maxTemp" style="width: 155px;">Water Level:</label>
                            <input type="number" name="tangki_air" wire:model="tangki_air" value="{{ $setting['tangki_air'] }}" style="width: 77px; border: none; padding: 5px;" />
                            <label for="maxTemp">Cm </label>
                          </div>
                          <br>
                          <div>
                            <label for="maxTemp" style="width: 155px;">Spraying Start:</label>
                            <input type="number" name="spray_start" value="{{ $setting['waktu_spary_start'] }}" wire:model="spray_start" style="width: 52px; border: none; padding: 5px;" />
                            <label for="maxTemp">Minute </label>
                          </div>
                          <div>
                            <label for="maxTemp" style="width: 155px;">Spraying End:</label>
                            <input type="number" name="spray_end" value="{{ $setting['waktu_spary_end'] }}" wire:model="spray_end" style="width: 50px; border: none; padding: 5px;" />
                            <label for="maxTemp">Minute</label>
                          </div>
                        </div>
                        <br>
                        ...
                        <div class="modal-footer">
                          <button class="btn btn-secondary mb-2" type="button" class="btn btn-secondary" wire:click="closeModal()">Close</button>
      ...
      <div class="row">
        <div class="col-xl-12 col-lg-12">
          <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              <h6 class="m-0 font-weight-bold text-primary" style="text-align: center; margin: 2%; width: 100%">Controlling Aerophonic</h6>
            </div>
            <div class="margin-top: 4" style="text-align: center; margin: 2%; width: 96%">
              <h2 class="text-danger">
                <b>Control is unavailable because the device is currently offline.</b>
              </h2>
            </div>
          </div>
        </div>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="row">
              <div class="col-xl-6 col-lg-12">
                <div class="card shadow mb-4">
                  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary" style="text-align: center; margin: 2%; width: 100%">Temp and Humidity</h6>
                  </div>
                  <div class="card-body">
