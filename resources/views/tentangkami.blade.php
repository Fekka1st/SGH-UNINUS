    ...
    <div class="container my-5">
        ...
        <div class="row mt-5">
            <div class="col-lg-10 offset-lg-1">
                ...
                <p>
                    Menjadi pelopor dalam penggunaan teknologi modern untuk pertanian berkelanjutan dan menciptakan
                    ekosistem yang harmonis antara teknologi dan alam.
                </p>
            </div>
        </div>
        ...
        <div class="row mt-4">
            <div class="col-lg-10 offset-lg-1">
                ...
                <ul>
                    <li>Menyediakan alat dan sumber daya yang dibutuhkan untuk mengoptimalkan hasil pertanian.</li>
                    <li>Meningkatkan kesadaran akan pentingnya praktik pertanian yang ramah lingkungan.</li>
                    <li>Membangun komunitas yang saling mendukung di antara para petani dan pengguna teknologi pertanian.</li>
                </ul>
            </div>
        </div>
        ...
        <div class="row mt-4">
            <div class="col-lg-10 offset-lg-1">
                <h3 class="mb-3">Nilai-nilai Kami</h3>
                <ul>
                    <li><strong>Inovasi:</strong> Kami selalu mencari cara baru dan kreatif untuk mengatasi tantangan dalam pertanian.</li>
                    <li><strong>Keberlanjutan:</strong> Kami berkomitmen untuk melindungi lingkungan dan memastikan bahwa praktik pertanian kami berkelanjutan.</li>
                    <li><strong>Kolaborasi:</strong> Kami percaya bahwa kerja sama dengan para petani, peneliti, dan pemangku kepentingan lainnya adalah kunci untuk mencapai kesuksesan.</li>
                    <li><strong>Pendidikan:</strong> Kami berusaha untuk mendidik pengguna kami tentang praktik pertanian terbaik dan pentingnya teknologi dalam pertanian.</li>
                </ul>
            </div>
        </div>
